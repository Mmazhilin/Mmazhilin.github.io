...
<html lang="zh-TW">
  ...
  <body>
    ...
    <script type="text/javascript" src="js/oder/menu_select.js"></script>
    <script type="text/javascript" src="js/oder/order_shopping.js"></script>
    <script type="text/javascript" src="js/oder/order_amount.js"></script>

    <!-- Include Bootstrap JS and dependencies -->
    <script src="https://code.jquery.com/jquery-3.5.1.slim.min.js" integrity="sha384-DfXdz2htPH0lsSSs5nCTpuj/zy4C+OGpamoFVy38MVBnE+IbbVYUew+OrCXaRkfj" crossorigin="anonymous"></script>
    <script
      src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.9.2/dist/umd/popper.min.js"
      integrity="sha384-IQsoLXlD+P0bbQd+DApM4jmbfG0fGZY9m1XkBtwlr99JT14NPyQwX0Y9JWq4sz0e"
